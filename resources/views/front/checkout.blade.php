                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="h6"><strong
                                            id="shippingAmount">${{ number_format($totatShippingCharge, 2) }}</strong>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == false) {
                        ...
                        if (errors.email) {
                            $("#email").siblings('p').addClass('invalid-feedback').html(errors
                                .email);
                        ...
                        if (errors.city) {
                            $("#city").siblings('p').addClass('invalid-feedback').html(errors
                                .city);
                        ...
                        if (errors.state) {
                            $("#state").siblings('p').addClass('invalid-feedback').html(errors
                                .state);
                        ...
                        if (errors.mobile) {
                            $("#mobile").siblings('p').addClass('invalid-feedback').html(errors
                                .mobile);
