                                ...
                                <div class="card-body text-center mt-3">
                                    ...
                                    <div class="price mt-2">
                                        ...
                                        @if ($relatedProduct->compare_price > 0)
                                            <span
                                                class="h6 text-underline"><del>${{ $relatedProduct->compare_price }}</del>
                                            </span>
                                        @endif
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        if (errors.name) {
                            $("#name").addClass('is-invalid').siblings('p').addClass('invalid-class')
                                .html(errors.name);
                        } else {
                            $("#name").removeClass('is-invalid').siblings('p').removeClass(
                                    'invalid-class')
                        ...
                        if (errors.email) {
                            $("#email").addClass('is-invalid').siblings('p').addClass('invalid-class')
                                .html(errors.email);
                        } else {
                            $("#email").removeClass('is-invalid').siblings('p').removeClass(
                                    'invalid-class')
                        ...
                        if (errors.comment) {
                            $("#comment").addClass('is-invalid').siblings('p').addClass('invalid-class')
                                .html(errors.comment);
                        } else {
                            $("#comment").removeClass('is-invalid').siblings('p').removeClass(
                                    'invalid-class')
